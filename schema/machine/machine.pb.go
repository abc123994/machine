...
func (x *Login_Ack) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Login_Ack) ProtoMessage() {}

func (x *Login_Ack) ProtoReflect() protoreflect.Message {
	mi := &file_machine_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Login_Ack.ProtoReflect.Descriptor instead.
func (*Login_Ack) Descriptor() ([]byte, []int) {
	return file_machine_proto_rawDescGZIP(), []int{1}
}

func (x *Login_Ack) GetResult() int32 {
	if x != nil {
		return x.Result
	}
	return 0
...
func (x *Test) GetCurrentTime() string {
	if x != nil {
...
var file_machine_proto_rawDesc = []byte{
	...
	,
...
var file_machine_proto_goTypes = []interface{}{
	(*Login)(nil),     // 0: machine.Login
	(*Login_Ack)(nil), // 1: machine.Login_Ack
	(*Test)(nil),      // 2: machine.Test
}
